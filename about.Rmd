...
**_The Host_** \  I am your host, Gen-Chang Hsu, currently an undergraduate at the Department of Life Science, National Taiwan University. I have broad interests in ecology, evolutionary biology, and data science, especially data visualization. Check out [my website](https://genchanghsu.github.io/){target="_blank"} for more information!

**_The Guest_** \  William Ou is an ecologist broadly interested in complexity science, eco-evolutionary dynamics, and more recently, cognitive psychology. When not sciencing, he enjoys biking around the city, eating ice cream, making generative art with ggplot, and watching netflix. Check out [his website](https://jiaangou.github.io/){target="_blank"} to learn more!
