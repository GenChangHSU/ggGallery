...
use `legend.text = element_text(margin = margin(r = 15))`
For example, the legend label setosa and the legend key for versicolor

`legend.spacing.x = unit()` is not relevant here.
...
P_horizontal_adjusted <- P_horizontal_default + 
  theme(legend.title = element_text(margin = margin(r = 10)),  # adjust the spacing between legend title and the first legend key
        ...
        legend.text = element_text(margin = margin(r = 15)))  # adjust the spacing between adjacent legend items
