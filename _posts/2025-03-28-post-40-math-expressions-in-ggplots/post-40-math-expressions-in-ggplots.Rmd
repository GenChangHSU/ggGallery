...
ggplot() +
  ...
  geom_richtext(aes(x = 1, y = 0.15), label = "This is a larger line break: <br> *p* = 0.001 <span style='font-size: 30pt; color: white'>.</span>", size = 5, hjust = 0, fill = NA, label.color = NA) + 
  scale_x_continuous(limits = c(0.9, 10)) +
  scale_y_continuous(limits = c(0, 1.1)) + 
  theme_void() +
  theme(plot.background = element_rect())
