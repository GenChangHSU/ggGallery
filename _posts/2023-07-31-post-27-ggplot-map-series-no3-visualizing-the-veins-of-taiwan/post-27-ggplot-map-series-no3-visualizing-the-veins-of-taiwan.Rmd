...
Let's do a little bit of modification to make the map artistic!
...
To summarize what we did, we obtained the river data of Taiwan from OSM using the package `osmdata` and visualized them in ggplots. We showcased the river data here, but the same principle applies to other features as well, and you can take advantage of them to create great thematic maps.
