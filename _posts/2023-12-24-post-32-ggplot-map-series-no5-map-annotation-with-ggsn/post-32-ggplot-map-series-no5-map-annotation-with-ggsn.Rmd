...
It's time to add a scale bar! `ggsn` has the function `scalebar()` to add and customize a scale bar. There are quite a few things you can adjust: the scale bar position, the segment distance and unit, the appearance of the bar and bar labels, etc.
...
Taiwan_elevation_map_annotated <- Taiwan_elevation_map + 
  scalebar(x.min = 121.9, 
           ...
           y.min = 21.6,
           y.max = 22.1,
           dist = 50,  # the distance of each segment of the scale bar
           dist_unit = "km",  # the unit of the scale bar 
