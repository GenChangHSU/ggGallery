...
In the above code, we supplied a vector of values for the argument in the function as well as the constant part of the code to start the first iteration. 
...
So on and so forth. The final plot was returned after the last iteration was completed.
