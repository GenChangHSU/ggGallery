...
ggplot(BES_journals_data) + 
  ...
  labs(title = "<img src='https://raw.githubusercontent.com/GenChangHSU/ggGallery/master/_posts/2022-08-01-post-18-bump-charts-with-ggplot/BES_logo.png' width = '100'/>",
       subtitle = "Journal rankings based on their impact factors each year",
       caption = "Data source: Journal Citation Reports") +
  theme_void() +
  theme(legend.position = "none",
        plot.background = element_rect(fill = "#abb8c3", color = NA),
        plot.title = element_markdown(margin = margin(b = 0, unit = "mm"), hjust = 0.05),
        plot.subtitle = element_text(margin = margin(t = -10, b = 10, unit = "mm"), hjust = 0.7, face = "bold", size = 13),
