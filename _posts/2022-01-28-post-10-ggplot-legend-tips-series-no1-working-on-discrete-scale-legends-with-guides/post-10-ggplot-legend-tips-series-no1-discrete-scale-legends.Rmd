...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(title = "Treatment",
                                title.position = "top",
                                title.theme = element_text(size = 15, color = "darkgreen", face = "bold.italic"),
                                title.hjust = 0.5,
                                title.vjust = 2))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(label = T,
                                label.position = "left",
                                label.theme = element_text(size = 12, color = "brown", face = "italic"),
                                label.hjust = 0.5,
                                label.vjust = 0.5))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(keywidth = unit(1, "inches"),
                                keyheight = unit(1, "inches")))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(direction = , 
                                nrow = ,
                                ncol = ,
                                byrow = ,
                                reverse = ))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(override.aes = ))
