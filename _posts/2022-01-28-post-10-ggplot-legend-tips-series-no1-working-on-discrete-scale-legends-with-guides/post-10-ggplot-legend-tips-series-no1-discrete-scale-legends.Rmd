...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(title = ,
                                title.position = ,
                                title.theme = ,
                                title.hjust = ,
                                title.vjust = ))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(label = ,
                                label.position = ,
                                label.theme = ,
                                label.hjust = ,
                                label.vjust = ))
...
```{r, fig.width = 5, fig.height = 3, out.width = "70%"}
P + guides(color = guide_legend(keywidth = ,
                                keyheight = ,
                                override.aes = ))
...
In fact, the arguments in `guides()` only affect the legends corresponding to the specified aesthetic, whereas the arguments in `theme()` will affect all the legends in the figure together. So if you have only one legend, basically using either function would give the same results. However, if you have multiple legends and you want to make different adjustments for them, then you should use `guides()` instead.


## Summary

In this post, we've learned how to modify the appearance and layout of legend items in discrete ggplot legends using the function `guides()`. We can even customize the legend keys by overriding the default aesthetics. Try playing around with the arguments a bit and I believe you will be albe to make a nice legend(s) for your figure!
