...
CA_park_map <- ggplot() + 
  ...
  geom_richtext(aes(x = -118.5, y = 40, label = "<img src='NPS_logo.PNG' width='25' />"),
                fill = NA, label.color = NA, label.padding = unit(rep(0, 4), "pt")) + 
  geom_richtext(aes(x = -115.5, y = 41.5, label = "What Is the Most Visited <br> National Parks in California?"),
                fill = NA, label.color = NA, label.padding = unit(rep(0, 4), "pt")) + 
  geom_richtext(aes(x = -113.5, y = 39.5, label = "hhh"),
                fill = NA, label.color = NA, label.padding = unit(rep(0, 4), "pt")) + 
  ...
  coord_sf(xlim = c(-125, -112), ylim = c(30.7, 42.2)) +
  ...
  theme(plot.background = element_rect(fill = "grey40", color = "grey40"),
        ...
        legend.text = element_text(size = 5, color = "white", margin = margin(t = -4)),
