...
1. Season is important: more in fall/winter time and fewer in spring/summer time, despite there is a peak around June/July

2. Weather doesn't matter that much


## Summary

To recap what we did, we first cleaned the data and summarize the counts and weather conditions by week, next we fit a LOESS curve to the weekly counts, and we created a time series chart, and finally we polished the chart by changing the font, text, legend and added a title and an image. 
