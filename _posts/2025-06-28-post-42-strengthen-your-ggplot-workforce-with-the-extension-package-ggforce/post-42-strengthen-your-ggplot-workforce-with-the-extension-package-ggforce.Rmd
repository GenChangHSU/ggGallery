...
<span style="display: block; margin-top: 5px; margin-left: 10px">(3) `geom_diagonal_wide()`, </span>
...
### 3. Other interesting & handy functions


geom_parallel_sets()
geom_arc_bar(stats = "pie") with explosion and donut charts
geom_voronoi()
geom_delaunay()
