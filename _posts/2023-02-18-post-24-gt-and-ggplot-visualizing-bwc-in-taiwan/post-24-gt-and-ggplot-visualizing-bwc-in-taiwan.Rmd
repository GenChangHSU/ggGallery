...
The first species, Taiwan barbet, is an endemic species in Taiwan. It is quite unexpected that this species tops the list given

Another surprising species on the list is the crested goshawk. Hard to imagine that 

This could potentially have some ecological impact as this species is a top predator in the ecosystem.

Many of these bird species live in urban or sub-urban areas, which explains why there are many collisions. But the issue is not limited to these urban dwellers. There is also a migratory bird, the pale thrush, and a species that lives close to the water bodies, the common kingfisher.
...
It is noteworthy that the numbers shown in the table are just the tip of the iceberg: a lot of bird-window collisions got unnoticed, or noticed but unreported. This issue has gained awareness in recent years and there is increasing research on why birds collide with windows. Hopefully, we will come up with solutions to this.
