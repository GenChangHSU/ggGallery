...
library(emo)  # Install from GitHub: devtools::install_github("hadley/emo")
...
```{r, fig.width = 5, fig.height = 5, out.width = "70%"}
# A quick look at the structure of the "penguins" dataset
glimpse(penguins)
...
*****Add a few opening sentences here? (e.g., Let's see how to visualize dynamic variables...; in this section, we are going to play with the "gapminder" dataset...; a brief intro to the dataset and what you are going to visualize here...)
