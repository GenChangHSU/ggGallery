...
<span style="display: block; color: red">Add a short description of the famous gapminder (with link) dataset here? Also one sentence or two of what you are going to visualize in the following figures (e.g., let's see how the relationship between GDP and life exp of each country in the four major continents changed over year...)?</span>
...
<span style="display: block; color: red">Maybe add the link to [this amazing talk](https://www.youtube.com/watch?v=jbkSRLYSojo&t=34s) by Hans Rosling too?</span>
