...
body > d-article > div:nth-child(50) > p > img {
...
However, this default behavior can sometimes be a bit troublesome because the legends (like the one above) or long axis text will take up extra space. To deal with this issue, we can use the function `free()` to "free" the plots from the alignment constraints. There are three ways to realign the plots:
