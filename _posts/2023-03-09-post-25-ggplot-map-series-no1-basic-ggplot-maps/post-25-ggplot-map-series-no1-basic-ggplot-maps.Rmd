...
Another thing we can do is to add points to the map. Let's get a list of top peaks in the world from Wikipedia and draw them on the map.

```{r, fig.width = 6, fig.height = 3, out.width = "80%", fig.show = "hold"}
library(rvest)

### Get a list of world's top peaks from Wikipedia
top_peaks_df <- read_html("https://en.wikipedia.org/wiki/List_of_highest_mountains_on_Earth") %>% 
...
Scrape a list of number of bird species by country
Check country names or modify them if needed
Merge the list into the map data 
