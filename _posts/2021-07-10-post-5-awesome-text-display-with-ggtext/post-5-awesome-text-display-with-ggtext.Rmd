...
```{r, fig.width = 6, fig.height = 6, out.width = "85%", fig.show = "hold"}
# Url of the logos (available on my GitHub repository)
logo_url <- "https://github.com/GenChangHSU/ggGallery/tree/master/_posts/2021-07-10-post-5-awesome-text-display-with-ggtext/IBO_logos"
