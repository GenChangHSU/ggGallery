...
You can add images to two places of a figure: the axis ticks and the plot panel.
...
# HTML <img> tags
IBO_logo <- rev(paste0("<img src = './IBO_logos/", Year, ".png' height = '15' width = '15' /><br>", Year))
